...
**IMPORTANT:** After Step 0 verification, tech-specific prompt files will be available in `./.agents/workflows/specify/`. These files take precedence over common files.

Before executing this workflow, you MUST have access to and reference these prompt files:

1. **Research & Analysis Prompt**
   - **Primary:** `./.agents/workflows/specify/research_plan_[TECH]_[LANGUAGE].prompt.md` (generated in Step 0)
...
2. **UI/UX Design Generator Prompt**
   - **Primary:** `./.agents/workflows/specify/ui_ux_design_generator_[TECH]_[LANGUAGE].prompt.md` (generated in Step 0)
   - **Fallback:** `./.agents/workflows/common/ui_ux_design_generator.prompt.md`
...
3. **UI/UX Bridge Prompt**
   - **Primary:** `./.agents/workflows/specify/ui_ux_bridge_[TECH]_[LANGUAGE].prompt.md` (generated in Step 0)
...
4. **Implementation Plan Prompt**
   - **Primary:** `./.agents/workflows/specify/implementation_plan_[TECH]_[LANGUAGE].prompt.md` (generated in Step 0)
   - **Fallback:** `./.agents/workflows/common/implementation_plan_common.prompt.md`
...
- Step 0.x updates under `./.agents/` (rules and command prompts only)
...
**Check process:**
1. List all files in `./.agents/workflows/specify/`
...
```
./.agents/workflows/specify/[FILENAME].prompt.md
```
...
**Check process:**
1. List all files in `./.agents/rules/`
...
```
./.agents/rules/project-rule_[TECH]_[LANGUAGE].mdc
```
...
**Deliverable:**
- ✅ Complete set of tech-specific command files in `./.agents/workflows/specify/`
- ✅ Tech-specific project rule file in `./.agents/rules/`
...
**⚠️ CRITICAL: The UI/UX Design Generator Prompt includes checking `.agents/workflows/common/ui_styles_reference.md`, `.agents/uiux_reference/data/`, and `.agents/uiux_reference/landing_page_prompts/` (when applicable) first to match project requirements with suitable UI styles. This step is mandatory and must be completed before proceeding.**

**File Path (from Step 0):**
- **Primary:** `./.agents/workflows/specify/ui_ux_design_generator_[TECH]_[LANGUAGE].prompt.md`
- **Fallback:** `./.agents/workflows/common/ui_ux_design_generator.prompt.md`

**UI Styles Reference:**
- **Location:** `./.agents/workflows/common/ui_styles_reference.md`
...
- **Location:** `./.agents/uiux_reference/data/`
...
- **Location:** `./.agents/uiux_reference/landing_page_prompts/`
...
**⚠️ CRITICAL: The UI/UX Bridge Prompt includes checking `.agents/workflows/common/ui_styles_reference.md`, `.agents/uiux_reference/data/`, and `.agents/uiux_reference/landing_page_prompts/` (when applicable) first in the PRE-PHASE to match project requirements with suitable UI styles. This step is mandatory and must be completed before proceeding to Phase 1.**
...
**File Path (from Step 0):**
- **Primary:** `./.agents/workflows/specify/implementation_plan_[TECH]_[LANGUAGE].prompt.md`
- **Fallback:** `./.agents/workflows/common/implementation_plan_common.prompt.md`
...
**Command Files Location:** `./.agents/workflows/specify/`
**Project Rule Location:** `./.agents/rules/`
...
- Step 2: `./.agents/workflows/specify/research_plan_[TECH]_[LANGUAGE].prompt.md` (or common fallback)
