...
1. **Read and analyze** `.kimi-code/commands/common/ui_styles_reference.md`
2. **Read and analyze** `.kimi-code/uiux_reference/data/` folder for UI/UX reference data:
...
3. **Read and analyze** `.kimi-code/uiux_reference/landing_page_prompts/` for full design prompts (when landing/marketing pages or style-led UI are relevant):
...
1. Reviewed `.kimi-code/commands/common/ui_styles_reference.md`
2. Reviewed `.kimi-code/uiux_reference/data/` folder:
...
3. Reviewed `.kimi-code/uiux_reference/landing_page_prompts/` (README.md + relevant style .md files) for full design prompts when landing/marketing or style-led UI is in scope
