...
Run this end-to-end ship flow. If `.omp/commands/ship-to-main.prompt.md` (or this agent’s mirrored `commands/` / `.agents/workflows/` copy) exists, **read and follow that file**. Otherwise use the steps below.
