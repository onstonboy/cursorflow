...
Run this end-to-end ship flow. If `.trae/commands/ship-to-develop.prompt.md` (or this agent’s mirrored `commands/` / `.agents/workflows/` copy) exists, **read and follow that file**. Otherwise use the steps below.
